...
#include "DAT_20948_AK09916.h"

void DAT_20948::write8(byte address, byte reg, byte value)
{
...
void DAT_20948::write8(byte reg, byte value)
{
...
byte DAT_20948::read8(byte address, byte reg)
{
  byte value;
...
DAT_20948::DAT_20948(int32_t accelSensorID, int32_t gyroSensorID, int32_t magSensorID)
{
...
bool DAT_20948::begin(icm20948AccelRange_t rngAccel, icm20948GyroRange_t rngGyro, icm20948AccelLowpass_t lowpassAccel, uint8_t accelgyro_address)
{
  /* Enable I2C */
  Wire.begin();
...
bool DAT_20948::getEvent(sensors_event_t* accelEvent, sensors_event_t* gyroEvent, sensors_event_t* magEvent)
{
  /* Clear the event */
...
bool DAT_20948::getEventAcc(sensors_event_t* accelEvent)
{
  /* Clear the event */
  memset(accelEvent, 0, sizeof(sensors_event_t));
...
bool DAT_20948::getEventMag(sensors_event_t* magEvent)
{
  /* Clear the event */
  memset(magEvent, 0, sizeof(sensors_event_t));
...
void  DAT_20948::getSensor(sensor_t* accelSensor, sensor_t* gyroSensor, sensor_t* magSensor)
{
...
bool DAT_20948::getEvent(sensors_event_t* accelEvent)
{
...
void  DAT_20948::getSensor(sensor_t* accelSensor)
{
    sensor_t accel;
...
void DAT_20948::standby(boolean standby)
{
